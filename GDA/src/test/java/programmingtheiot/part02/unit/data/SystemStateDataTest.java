 ...
 * SystemStateDataTest. It should not be considered complete,
...
public class SystemStateDataTest
{
	...
	public static final String DEFAULT_LOCATION = "My Home";
	...
	public void testParameterUpdates()
	{
		...
		assertEquals(ssd.getLocation(), DEFAULT_LOCATION);
		assertTrue(ssd.getActionCommand() == DEFAULT_ACTION_CMD);
	...
	private SystemStateData createTestData()
	{
		...
		ssd.setLocation(DEFAULT_LOCATION);
		ssd.setActionCommand(DEFAULT_ACTION_CMD);
