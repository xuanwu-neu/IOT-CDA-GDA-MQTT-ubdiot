...
public enum ResourceNameEnum
{
	...
	CDA_ACTUATOR_RESPONSE_MSG_RESOURCE(ConfigConst.CDA_ACTUATOR_RESPONSE_MSG_RESOURCE),
	...
	CDA_UBIDOTS(ConfigConst.CDA_UBIDOTS),
	GDA_UBIDOTS_SYS(ConfigConst.GDA_UBIDOTS_SYS),
	GDA_UBIDOTS(ConfigConst.GDA_UBIDOTS),
	CDA_UBIDOTS_PRESS(ConfigConst.CDA_UBIDOTS_PRESS),
	CDA_UBIDOTS_BPD(ConfigConst.CDA_UBIDOTS_BPD),
	CDA_UBIDOTS_BT(ConfigConst.CDA_UBIDOTS_BT),
	CDA_UBIDOTS_SYS(ConfigConst.CDA_UBIDOTS_SYS);
