...
public class ConfigConst
{
	...
	public static final String DEFAULT_COAP_SECURE_PROTOCOL = "coap";
	...
	public static final String GDA_UBIDOTS  = "v1.6/devices/GatewayDevice/" + MGMT_STATUS_MSG;
	public static final String CDA_UBIDOTS  = "v1.6/devices/ConstrainedDevice/" + SENSOR_MSG;
	public static final String GDA_UBIDOTS_SYS  = "v1.6/devices/GatewayDevice/" + SYSTEM_PERF_MSG;
	public static final String CDA_UBIDOTS_PRESS  = "v1.6/devices/ConstrainedDevice/" + "press-actuator";
	public static final String CDA_UBIDOTS_BPD  = "v1.6/devices/ConstrainedDevice/" + "bloodpressure-actuator";
	public static final String CDA_UBIDOTS_BT  = "v1.6/devices/ConstrainedDevice/" + "bodyTemperature-actuator";
	public static final String CDA_UBIDOTS_SYS  = "v1.6/devices/ConstrainedDevice/" + SYSTEM_PERF_MSG;
