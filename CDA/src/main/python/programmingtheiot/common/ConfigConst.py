...
BLOOD_PRESSURE_UP_ACTUATOR_NAME = 'BloodPressureUpActuator'
BLOOD_PRESSURE_DOWN_ACTUATOR_NAME = 'BloodPressureDownActuator'
BODY_TEMP_UP_ACTUATOR_NAME = 'BodyTempUpActuator'
BODY_TEMP_DOWN_ACTUATOR_NAME = 'BodyTempDownActuator'
HEART_RATE_UP_ACTUATOR_NAME = 'HeartRateUpActuator'
HEART_RATE_DOWN_ACTUATOR_NAME = 'HeartRateDownActuator'

HEART_RATE_SENSOR_NAME = 'HeartRateSensor'
BLOOD_PRESSURE_SENSOR_NAME = 'BloodPressureSensor'
BODY_TEMP_SENSOR_NAME = 'BodyTempSensor'
...
MQTT_CLOUD_SECTION= 'MqttCloudSection'
