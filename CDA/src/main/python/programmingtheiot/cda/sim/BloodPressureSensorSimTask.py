...
class BloodPressureSensorSimTask(BaseSensorSimTask):
	"""
	...
	def __init__(self, dataSet = None):
		super(BloodPressureSensorSimTask, self).__init__(SensorData.BLOOD_PRESSURE_SENSOR_TYPE, dataSet = dataSet, minVal = SensorDataGenerator.LOW_NORMAL_ENV_PRESSURE, maxVal = SensorDataGenerator.HI_NORMAL_ENV_PRESSURE, sensorName = ConfigConst.BLOOD_PRESSURE_SENSOR_NAME)
